(() => {
    ...
    var n = function() {
        function n() {
            ...
            }(this, n), a(this, "xhr", null), a(this, "doingAjax", !1), a(this, "originalSearch", location.search), a(this, "initialized", !1);
            var t = e("head").html(),
                i = document.title,
        ...
        return r = n, (l = [{
            ...
            value: function(t, i, a) {
                var n, r, l = this,
                    s = e(i || "body");
                if ((r = e(document).triggerHandler("yith_wcan_filters_parameters", [t])) && (t = r), s && this.block(s), n = this.buildUrl(t), yith_wcan_shortcodes.ajax_filters) return this.doingAjax = !0, this._doAjax(n).done((function(e) {
            ...
            value: function(t, i) {
                ...
                })), i && Object.keys(i).length ? e("body").addClass("filtered") : e("body").removeClass("filtered"), e(window).trigger("scroll"), e(document).trigger("yith-wcan-ajax-filtered", [t, i]).trigger("yith_wcwl_reload_fragments")
            }
        }, {
            key: "buildUrl",
            value: function(i) {
                ...
                if (yith_wcan_shortcodes.session_param && (o = o.replace(new RegExp("/" + yith_wcan_shortcodes.session_param + "/[^/]*/"), "")), h && (l[r] = 1), this.originalSearch) {
                    var d = this.originalSearch.replace("?", "").split("&").reduce((function(e, t) {
                        var i = t.split("=");
                        if (2 === i.length) {
                ...
                return h && (l = e.extend(l, i)), (a = Object.keys(l).reduce((function(e, t) {
                    var i = l[t];
                    return i && t ? e += c._cleanParam(t) + "=" + c._cleanParam(i) + "&" : e
                }), "?").replace(/&$/g, "").replace(/%2B/g, "+").replace(/%2C/g, ",")).length > 1 && (o += a), o
            }
        }, {
            ...
            value: function(e, t) {
                yith_wcan_shortcodes.change_browser_url && !navigator.userAgent.match(/msie/i) && window.history.pushState({
                    pageTitle: t
                }, "", e)
            }
        }, {
            ...
            key: "_doAjax",
            value: function(t, i) {
                return this.xhr && this.xhr.abort(), i = e.extend({
                    url: t,
                    headers: {
                        "X-YITH-WCAN": 1
                    }
                }, i), this.xhr = e.ajax(i), this.xhr
            }
        }, {
            key: "block",
            value: function(t) {
                ...
                if (void 0 !== e.fn.block) {
                    ...
                    null !== (i = yith_wcan_shortcodes) && void 0 !== i && i.loader && (a = "url('".concat(yith_wcan_shortcodes.loader, "') ").concat(a)), t.block({
                        message: null,
                        overlayCSS: {
                            background: a,
                            opacity: .7
            ...
            key: "isFilterParam",
            value: function(t) {
                var i, a = ["rating_filter", "min_price", "max_price", "price_ranges", "onsale_filter", "instock_filter", "featured_filter", "orderby", "product-page", yith_wcan_shortcodes.query_param];
                return (i = e(document).triggerHandler("yith_wcan_supported_filters_parameters", [a])) && (a = i), -1 !== (a = a.concat(yith_wcan_shortcodes.supported_taxonomies.map((function(e) {
                    return e.replace("pa_", "filter_")
                })))).indexOf(t) || -1 !== t.indexOf("filter_") || -1 !== t.indexOf("query_type_")
            }
        }]) && i(r.prototype, l), s && i(r, s), n
    }();
    var r = function t(i) {
        var a, n, r;
        ! function(e, t) {
            if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
        }(this, t), r = null, (n = "$reset") in (a = this) ? Object.defineProperty(a, n, {
            value: r,
            enumerable: !0,
            configurable: !0,
            writable: !0
        }) : a[n] = r, this.$reset = i, this.$reset.on("click", (function(t) {
            t.preventDefault(), e(".yith-wcan-filters").each((function() {
    ...
    var h = function() {
        function t(i, a) {
            if (function(e, t) {
                    if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
                }(this, t), c(this, "$originalSelect", null), c(this, "$_main", null), c(this, "$_label", null), c(this, "$_dropdown", null), c(this, "$_search", null), c(this, "$_showMore", null), c(this, "$_items", null), c(this, "currentPage", 1), c(this, "options", {}), this.$originalSelect = i, this.$originalSelect.is("select")) {
        ...
        return i = t, (a = [{
            ...
            value: function() {
                ...
                a.append(n), t.append(i).append(a), this.options.showSearch && this._initSearchTemplate(a), this.options.paginate && this._initShowMoreTemplate(a), this.$originalSelect.after(t), this.$_main = t, this.$_label = i, this.$_dropdown = a, this.$_items = n
            }
        }, {
            ...
            value: function() {
                var t, i, a = this;
                null === (t = this.$_main) || void 0 === t || t.on("click", (function(e) {
                    e.stopPropagation(), a.toggleDropdown()
                })), this.$_dropdown.on("click", (function(e) {
                    e.stopPropagation()
                })), null === (i = this.$_search) || void 0 === i || i.on("keyup search", (function() {
                    a._populateItems()
                })), this.$_items.on("change", ":input", (function() {
                    var t, i = e(this).closest("li"),
                        n = i.data("value");
                    ...
                    i || (a.$_items.find("li").each((function() {
            ...
            value: function() {
                var t = this;
                e(document).find("select.enhanced").filter((function(i, a) {
                    var n = e(a);
                ...
                return new Promise((function(l) {
                    r.each((function() {
                        var i = e(this),
                            ...
                            r = i.html(),
                            l = new RegExp(".*" + t + ".*", "i");
                        (!t || l.test(a) || l.test(r)) && n.push({
                            value: a,
                            label: r
                        })
                    })), a.options.getElements ? a.options.getElements(t).then((function(t) {
                        t && (t = t.reduce((function(e, t, i) {
                            return e.push({
                                label: i,
                                value: t
                            }), e
                        }), []), n = e.extend(n, t)), l(a._formatItems(n, i))
            ...
            key: "_generateItem",
            value: function(t, i) {
                var a, n = this.isValueSelected(t),
                    r = this.getOptionByValue(t),
                    l = e("<li/>", {
                        "data-value": t,
                        class: r.length ? r.attr("class") : ""
                    });
                if (r.length) {
                ...
                if (a = e("<a/>", {
                        href: r.length ? r.data("filter_url") : "#",
                        html: i,
                        "data-title": r.length ? r.data("title") : ""
                    }), this.$originalSelect.prop("multiple")) {
                    var c = e("<input/>", {
                            type: "checkbox",
                            value: t
                        }),
            ...
            value: function(t) {
                ...
                a = (t = t ? parseInt(t) : 1) * s, this.getMatchingElements(r, a).then((function(i) {
                    var a = i.items,
                        r = [],
                        s = !1;
                    if (n._emptyItems(), n._hideLoadMore(), a.length) {
                        ...
                        text: n.options.labels.noItemsFound
                    })), n.currentPage = 1;
            ...
            value: function() {
                var t = [];
                return this.getSelectedOptions().each((function() {
                    var i = e(this),
                        a = i.data("template");
    ...
    var p = function() {
        function t(i) {
            ! function(e, t) {
                if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
            }(this, t), f(this, "preset", !1), f(this, "$preset", !1), f(this, "target", !1), f(this, "$target", !1), f(this, "$filters", !1), f(this, "$filterButtons", !1), f(this, "modalElements", {}), f(this, "activeFilters", !1), f(this, "isMobile", !1), f(this, "sliderTimeout", !1), f(this, "originalFilters", null), f(this, "dirty", !1), this.preset = "#" + i.attr("id"), this.$preset = i, this.target = this.$preset.data("target"), this.$target = !!this.target && e(this.target), this._regiterStatus(), this._initFilterButton(), this._initResponsive(), this._initFilters(), this._initActions(), this.$preset.data("preset", this).addClass("enhanced").trigger("yith_wcan_preset_initialized", [this])
        }
        var i, a, n;
        return i = t, (a = [{
            key: "_initFilters",
            ...
            value: function() {
                var e = this;
                this.$filterButtons = this.$preset.find(".apply-filters"), this.$filterButtons.length && this.$filterButtons.on("click", (function(t) {
            ...
            value: function(t) {
                var i, a = this,
                    n = function(i) {
                        ...
                        i.preventDefault(), o.length && !l && o.removeClass("active").children("label").find(":input").prop("checked", !1).parent(".checked").removeClass("checked"), s.length && s.toggleClass("active"), a.activeFilters = !1, a.maybeFilter(t), a.maybeToggleClearAllFilters(), a.maybeToggleClearFilter(r)
                    };
                t.find(".filter-item").not(".checkbox").not(".radio").on("click", "a", (function(t) {
                ...
                })), this._initTooltip(t), this._initPriceSlider(t), this._initDropdown(t), this._initCollapsable(t), this.maybeShowClearFilter(t), null !== (i = this.$preset) && void 0 !== i && i.hasClass("custom-style") && this._initCustomInput(t)
            }
        }, {
            key: "_initTooltip",
            value: function(t, i) {
                t.find("[data-title]").each((function() {
                    var t = e(this);
                    !t.hasClass("tooltip-added") && t.data("title") && (t.on("mouseenter", (function() {
                        var t, a = e(this),
                            n = null,
                            r = a.outerWidth(),
                            l = 0;
                        ...
                        n = e("<span>", {
                            ...
                            html: a.data("title")
                        }), a.append(n), t = n.outerWidth() + 6, n.outerWidth(t), l = "top" === i ? (r - t) / 2 : r + 15, n.css({
                            left: l.toFixed(0) + "px"
                        }).fadeIn(200), a.addClass("with-tooltip")
            ...
            value: function(t) {
                ...
                i.length && (i.hasClass("select2-hidden-accessible") && void 0 !== e.fn.selectWoo && i.selectWoo("destroy"), this._initDropdownObject(i, {
                    paginate: !0,
            ...
            value: function(e) {
                ...
                if (e.hasClass("filter-price-slider")) {
                    var i = this,
                        ...
                        d = function() {
                            i.sliderTimeout && clearTimeout(i.sliderTimeout), i.sliderTimeout = setTimeout((function() {
                                i.maybeFilter(e)
                            }), 200)
                        };
                    e.find(".price-slider-ui").ionRangeSlider({
                        ...
                        onFinish: d
                    }), n.add(r).off("change").on("keyup", (function() {
                        n.val() && r.val() && d()
                    }))
                }
            }
            ...
            value: function(t) {
                ...
                if (i.length) {
                    var a = this,
                        n = t.find(".active");
                    n.length && (n.parents(".hierarchy-collapsable").removeClass("closed").addClass("opened"), n.hasClass("hierarchy-collapsable") && yith_wcan_shortcodes.show_current_children && n.removeClass("closed").addClass("opened")), i.each((function() {
                        var t = e(this),
                            i = e("<span/>", {
                                class: "toggle-handle"
                            });
            ...
            value: function(e, t, i) {
                t.hasClass("closed") && i.hide(), e.off("click").on("click", (function(e) {
                    e.stopPropagation(), e.preventDefault(), i.slideToggle(400, (function() {
            ...
            value: function(t) {
                t.find(":input").each((function() {
                    var t, i = e(this),
                        a = i.attr("type"),
                        n = "".concat(a, "button");
                    "checkbox" !== a && "radio" !== a || i.closest(".".concat(n)).length || (i.is(":checked") && (n += " checked"), t = e("<span/>", {
                        class: n
            ...
            value: function() {
                var t, i;
                this.isMobile ? (this.$preset.addClass("filters-modal").attr("role", "dialog").attr("tabindex", "-1").hide(), this._addCloseModalButton(), this._addApplyFiltersModalButton(), this._switchToCollapsables(), null === (t = this.$filterButtons) || void 0 === t || t.hide()) : (this.$preset.removeClass("filters-modal").removeClass("open").removeAttr("role").removeAttr("tabindex").show(), e("body").css("overflow", "auto").removeClass("yith-wcan-preset-modal-open"), this._removeCloseModalButton(), this._removeApplyFiltersModalButton(), this._switchBackCollapsables(), null === (i = this.$filterButtons) || void 0 === i || i.show())
            }
        }, {
            ...
            value: function() {
                var t = this;
                this.$filters.not(".no-title").not((function(i, a) {
            ...
            value: function() {
                ...
                null == r || null === (i = r.doFilter(this.getFiltersProperties(), this.target, this.preset)) || void 0 === i || i.done((function() {
                    var t = e(n.preset);
                ...
                switch (n) {
                    case "tax":
                        var o = [],
                            ...
                            d = t.data("relation");
                        if (l.length ? r ? o = l.val() : o.push(l.val()) : o = (a = t.find(".filter-item").filter(".active").children("a, label")).get().reduce((function(t, i) {
                                var a;
                        ...
                        break;
                    case "review":
                        l.length ? s.rating_filter = l.val() : (a = t.find(".filter-item").filter(".active").children("a, label"), r ? s.rating_filter = a.get().reduce((function(t, i) {
                            var a;
                            return (a = (i = e(i)).is("label") ? i.find(":input").val() : i.data("rating")) ? (t.push(a), t) : t
                        }), []).join(",") : (a = a.first(), s.rating_filter = a.is("label") ? a.find(":input").val() : a.data("rating")));
                        break;
                    case "price_range":
                        l.length ? r ? s.price_ranges = l.val().join(",") : (s.min_price = l.val().split("-")[0], s.max_price = l.val().split("-")[1]) : (a = t.find(".filter-item").filter(".active").children("a, label"), r ? s.price_ranges = a.get().reduce((function(t, i) {
                            var a = e(i).data("range-min"),
                                n = e(i).data("range-max");
                            return t += (n ? "".concat(a, "-").concat(n) : a) + ","
                        }), "").replace(/^(.*),$/, "$1") : (s.min_price = parseFloat(a.first().data("range-min")), s.max_price = parseFloat(a.first().data("range-max"))));
                        break;
                    case "price_slider":
            ...
            value: function() {
                var t = {},
                    i = this;
                return this.getFilters().each((function() {
                    var a = e(this);
            ...
            value: function(t) {
                var i = this;
                this.isFilterActive(t) && yith_wcan_shortcodes.show_clear_filter && (t.find(".clear-selection").remove(), e("<a/>", {
                    class: "clear-selection",
                    text: yith_wcan_shortcodes.labels.clear_selection,
                    role: "button"
                }).prependTo(t.find(".filter-content")).on("click", (function(e) {
            ...
            value: function() {
                var t = this;
                this.isAnyFilterActive() && this.isMobile && (this.$preset.find(".clear-selection").remove(), e("<a/>", {
                    class: "clear-selection",
                    text: yith_wcan_shortcodes.labels.clear_all_selections,
                    role: "button"
                }).prependTo(this.$preset.find(".filters-container")).on("click", (function(e) {
            ...
            value: function(t, i, a) {
                ...
                switch (n) {
                    case "tax":
                        ...
                        s.length ? (i ? s.find("option").each((function() {
                            var t = e(this);
                            t.val().toString() === i[o].toString() && t.prop("selected", !1)
                        })) : s.find("option").prop("selected", !1), s.change()) : i ? l.each((function() {
                            var t = e(this),
                                a = t.children("label"),
                                n = t.children("a");
                    ...
                    case "price_range":
                        s.length ? (i ? s.find("option").each((function() {
                            ...
                            var t, a, n = e(this),
                                r = n.children("label"),
                                l = n.children("a");
                            a = r.length ? r.find(":input").val() : l.data("min_price") + (l.data("max_price") ? "-" + l.data("max_price") : ""), i.min_price ? t = i.min_price + (i.max_price ? "-" + i.max_price : "") : i.price_ranges && (t = i.price_ranges), a === t && (n.children("label").children("a").click(), n.removeClass("active"))
                        })) : (l.children("label").children("a").click(), l.removeClass("active"));
                        break;
                    case "price_slider":
                    ...
                    case "orderby":
                        ...
                        break;
                    case "stock_sale":
                        i ? (null != i && i.instock_filter && t.find(".filter-in-stock").find(":input").prop("checked", !1).change().closest(".filter-item").removeClass("active"), null != i && i.onsale_filter && t.find(".filter-on-sale").find(":input").prop("checked", !1).change().closest(".filter-item").removeClass("active"), null != i && i.featured_filter && t.find(".filter-featured").find(":input").prop("checked", !1).change().closest(".filter-item").removeClass("active")) : (t.find(".filter-in-stock").find(":input").prop("checked", !1).change(), t.find(".filter-on-sale").find(":input").prop("checked", !1).change(), t.find(".filter-featured").find(":input").prop("checked", !1).change(), r.removeClass("active"));
                        break;
                    default:
            ...
            value: function(t) {
                ...
                })), this.activeFilters = !1, t && this.filter()
            }
        }, {
            ...
            value: function() {
                var t = this;
                this.isMobile && (yith_wcan_shortcodes.toggles_open_on_modal ? this._openAllCollapsables() : this._closeAllCollapsables(), e("body").css("overflow", "hidden").addClass("yith-wcan-preset-modal-open"), this.$preset.show(), setTimeout((function() {
            ...
            value: function() {
                var t = this;
                this.isMobile && (this.$preset.removeClass("open"), setTimeout((function() {
            ...
            key: "formatPrice",
            value: function(e) {
                return "undefined" != typeof accounting && (e = accounting.formatMoney(e, {
                        ...
                        switch (n) {
                            ...
                            default:
                                if (0 === n.indexOf("query_type_")) t[n] = i[n];
                                    ...
                                    if (s = s.split(l).filter((function(e, t, i) {
        ...
        }]) && u(i.prototype, a), n && u(i, n), t
    }();
    jQuery((function(e) {
        e(document).on("yith_wcan_init_shortcodes yith_plugin_fw_gutenberg_success_do_shortcode", (function() {
            e(".yith-wcan-filters").not(".enhanced").each((function() {
                new p(e(this))
            })), e(".yith-wcan-reset-filters").not(".enhanced").each((function() {
                new r(e(this))
            }))
        })).trigger("yith_wcan_init_shortcodes"), globalThis.product_filter = new n
    }))
})();