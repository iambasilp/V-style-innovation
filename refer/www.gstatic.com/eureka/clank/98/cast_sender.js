(function() {
    ...
    */
    ...
    var Fa = function(a) {
        ...
        Ga = new B(t.trustedTypes && t.trustedTypes.emptyHTML || "", 0, Ea);
    var Ha = {
            MATH: !0,
            SCRIPT: !0,
            STYLE: !0,
                    ...
                    if (void 0 === z) {
                        ...
                        if (k && k.createPolicy) {
                            try {
                                ...
                                t.console && t.console.error(l.message)
                            }
                            z = e
                        } else z = e
                    }
    ...
    var D = "StopIteration" in t ? t.StopIteration : {
    ...
    var fb = function(a, b, c, d, e, h, k, l, p, r, mb, nb) {
            this.L = a;
            this.g = b || null;
            this.l = c || null;
            this.C = d || null;
        ...
        jb = function(a, b) {
            ...
            if (a.playerState == chrome.cast.media.G.IDLE && null == a.loadingItemId) a.currentItemId = null, a.loadingItemId = null, a.preloadedItemId = null, a.items = null;
                ...
                for (h = b.next(); !h.done; h = b.next()) {
                    ...
                    l = k.push;
                    var p = void 0,
                        r = new chrome.cast.media.xa(h.media);
                    for (p in h) h.hasOwnProperty(p) && (r[p] = h[p]);
                    l.call(k, r)
                }
                a.items = e
            }
    ...
    R.prototype.stop = function() {
        this.g && (t.clearTimeout(this.g), this.g = null, this.j = !1, this.m = null)
    };
    ...
    var sb = {},
        S = null,
        tb = ob || pb || "function" == typeof t.btoa,
        ub = function(a) {
            if (tb) var b = t.btoa(a);
            else {
                b = [];
    ...
    V.prototype.initialize = function(a, b) {
        ...
        a.invisibleSender || (a = new PresentationRequest(X(this)), a.getAvailability().then(function(d) {
            ...
            Y(c, d.connection)
        }, this.la = (t.navigator || null).presentation.defaultRequest = a, a.reconnect(chrome.cast.Xa).then(function(d) {
            Y(c,
                d)
        }, la));
        b && b(void 0)
    ...
    var X = function(a, b, c, d) {
        var e = null,
            ...
            l = k.dialRequest;
        l && (e = l.appName, (h = l.launchParameter) && !h.match(Bb) && (h = ub(h)));
        var p = [];
        p.push({
            appId: k.appId,
            capabilities: k.capabilities
        });
        b || ua(a.g.additionalSessionRequests, function(r) {
            p.push({
                appId: r.appId,
                capabilities: r.capabilities
            })
        });
        return gb(new fb(p, a.B.j, a.g.autoJoinPolicy, a.g.defaultActionPolicy, k.requestSessionTimeout, e, h, a.g.invisibleSender, c, d, k.androidReceiverCompatible, k.credentialsData))
    };
    ...
    chrome.cast.unescape = function(a) {
        return -1 != a.indexOf("&") ? "document" in t ? Ka(a) : La(a) : a
    };
